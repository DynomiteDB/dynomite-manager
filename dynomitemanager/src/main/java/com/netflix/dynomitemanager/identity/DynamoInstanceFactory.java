...
/**
 * Factory to use Amazon dynamo for managing instance data
 */

@Singleton public class DynamoInstanceFactory implements IAppsInstanceFactory {
	private static final Logger logger = LoggerFactory.getLogger(DynamoInstanceFactory.class);

	IConfiguration config;

	InstanceDataDAODynamo dao;

	@Inject
	public DynamoInstanceFactory(IConfiguration config, InstanceDataDAODynamo dao) {
		this.config = config;
		this.dao = dao;
	}
